export default function handler(_request, response) {
  ...
  response.status(200).json({
    ...
    // OAuth client IDs are public identifiers. Supplying this to Google Identity
    // Services lets installed PWAs complete sign-in in their own browser context.
    googleClientId: process.env.GOOGLE_CLIENT_ID || '558513686650-9ql0o9e1uot2nupemq0l65qs3rqt5cga.apps.googleusercontent.com',
